...
INSERT INTO `__new_partida`("id", "created_at", "JugadorW", "JugadorB", "Modo", "Ganador", "PGN", "Variacion_JW", "Variacion_JB", "Tipo") SELECT "id", "created_at", "JugadorW", "JugadorB", "Modo", "Ganador", "PGN", "Variacion_JW", "Variacion_JB", "Tipo" FROM `partida`;--> statement-breakpoint
